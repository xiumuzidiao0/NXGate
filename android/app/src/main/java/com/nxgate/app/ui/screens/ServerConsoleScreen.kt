...
fun ServerConsoleScreen(
    ...
    val cleartextWarningEnabled by NXGateApplication.instance.serverStore.cleartextWarningEnabled.collectAsState()
                ...
                actions = {
                    IconButton(
                        onClick = {
                            if (activeServer != null) {
                                scope.launch {
                                    val statusRes = NXGateApplication.instance.apiClient.fetchStatus(activeServer)
